    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="color: black;">
		...
		<tr>
			<td>
				...
				Não se esqueça que sua senha diferencia minúsculas de maiúsculas e que deve ter pelo menos oito caracteres.
				</p>
				<p>Você não requisitou alteração da sua senha? Então por gentileza ignore esse e-mail e caso tenha qualquer
				dúvida entre em contato conosco pelo e-mail <span >ongsjpa@gmail.com</span>.</p>
			</td>
		</tr>
        <tr>
            <td>
